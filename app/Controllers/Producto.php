...
class Producto extends BaseController
{
    ...
    public function traer(){ 
        ...
        $validacion = $this->validate([
            ...
            'codigo' => ['rules' => 'required|numeric|max_length[50]|is_unique[producto.codigo]|greater_than[-1]', 
            'errors' => [
            ...
            'nombre' => ['rules' => 'required|min_length[6]|max_length[30]', 
            'errors' => [
            ...
            'descripcion' => ['rules' => 'required|max_length[250]', 
            'errors' => [
            ...
            'precio' => ['rules' => 'required|numeric|greater_than[0]', 
            'errors' => [
